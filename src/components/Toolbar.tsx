...
export default function Toolbar({ count }: { count: number }) {
  ...
  return (
    <div className={`sticky top-14 z-30 -mx-[22px] border-b border-hair bg-[rgba(251,251,253,.88)] px-[22px] py-3 backdrop-blur-xl transition-opacity ${pending ? "opacity-60" : ""}`}>
